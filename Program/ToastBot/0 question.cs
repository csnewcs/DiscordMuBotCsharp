...
namespace ToastBot
{
    ...
    .AddField("청소", "채팅방을 청소해준다 ~~핸드폰에서는 아닌 듯 하다~~뮤!")
    .AddField("빵굽기", "당신의 운을 시험해라. 만약 빵이 적당히 구워지면 투자가 가능한 빵이 된다뮤!")
    .AddField("투자", "빵굽기로 얻은 빵을 이용해 투자를 합니다 투자한 금액의 1/5~4배까지 얻을 수 있다뮤!")
    .AddInlineField("빵은행", "현재 가지고 있는 빵의 갯수를 보여준다뮤!")
    .AddInlineField("나머지?", "아직 읍서요");
